...
class productClass:
    def __init__(self, root):
        ...
        # ===============button
        btn_add = Button(product_Frame, text="Save", command=self.add, cursor="hand2", font=("goudy old style", 15),
                         bg="#2196f3", fg="white").place(x=10, y=400, width=100, height=40)
        btn_update = Button(product_Frame, text="Update", command=self.update, cursor="hand2",
                            font=("goudy old style", 15), bg="#4caf50", fg="white").place(x=120, y=400, width=100,
                                                                                          height=40)
        btn_delete = Button(product_Frame, text="Delete", command=self.delete, cursor="hand2",
                            font=("goudy old style", 15), bg="#f44336", fg="white").place(x=230, y=400, width=100,
                                                                                          height=40)
        btn_clear = Button(product_Frame, text="Clear", command=self.clear, cursor="hand2",
                           font=("goudy old style", 15), bg="#607d8b", fg="white").place(x=340, y=400, width=100,
                                                                                         height=40)

        # ================SearchFrame
        SearchFrame = LabelFrame(self.root, text="Search Product", font=("goudy old style", 13, "bold"), bd=2,
                                 relief=RIDGE, bg="white")
        SearchFrame.place(x=480, y=10, width=600, height=80)

        # =======options
        cmb_search = ttk.Combobox(SearchFrame, textvariable=self.var_searchby,
                                  values=("Select", "Category", "Supplier", "Product Name"), state='readonly',
                                  justify=CENTER, font=("goudy old style", 15))
