...
from PIL import ImageTk  # type "Pip install pillow" in your terminal to install ImageTk and Image module
...
# Window Icon Photo
icon = ImageTk.PhotoImage(file='vector.jpg')
...
# ===== Email icon =========
email_icon = ImageTk.PhotoImage(file='email-icon.jpg')
emailIcon_label = Label(design_frame4, bg='#f8f8f8')
emailIcon_label.place(x=105, y=174)

# ===== word icon =========
password_icon = ImageTk.PhotoImage(file='pass-icon.jpg')
password_icon_label = Label(design_frame4, bg='#f8f8f8')
password_icon_label.place(x=105, y=254)

# ===== picture icon =========
picture_icon = ImageTk.PhotoImage(file='pic-icon.jpg')
picture_icon_label = Label(design_frame4, bg='#f8f8f8')
picture_icon_label.place(x=280, y=5)

# ===== Left Side Picture ============
side_image = ImageTk.PhotoImage(file='vector.jpg')
side_image_label = Label(design_frame1, image=side_image, bg='#1e85d0')
...
# ===== password icon =========
password_icon = ImageTk.PhotoImage(file='pass-icon.jpg')
password_icon_label = Label(design_frame8, image=password_icon, bg='#f8f8f8')
password_icon_label.place(x=255, y=300)

# ===== confirm password icon =========
confirmPassword_icon = ImageTk.PhotoImage(file='pass-icon.jpg')
confirmPassword_icon_label = Label(design_frame8, image=confirmPassword_icon, bg='#f8f8f8')
confirmPassword_icon_label.place(x=255, y=390)

# ===== Email icon =========
email_icon = ImageTk.PhotoImage(file='email-icon.jpg')
emailIcon_label = Label(design_frame8, image=email_icon, bg='#f8f8f8')
emailIcon_label.place(x=255, y=225)

# ===== Full Name icon =========
name_icon = ImageTk.PhotoImage(file='name-icon.jpg')
nameIcon_label = Label(design_frame8, image=name_icon, bg='#f8f8f8')
nameIcon_label.place(x=252, y=153)

# ===== picture icon =========
picture_icon = ImageTk.PhotoImage(file='pic-icon.jpg')
picture_icon_label = Label(design_frame8, image=picture_icon, bg='#f8f8f8')
picture_icon_label.place(x=280, y=5)

# ===== Left Side Picture ============
side_image = ImageTk.PhotoImage(file='vector.jpg')
side_image_label = Label(design_frame7, image=side_image, bg='#1e85d0')
side_image_label.place(x=50, y=10)
