...
class salesClass:
    def __init__(self, root):
        ...
        self.root.title("PHARMACEUTICAL MANAGEMENT SYSTEM")
        ...
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=("times new roman", 15, "bold"),
                           bg="lightgray", cursor="hand2").place(x=490, y=100, width=120, height=28)
        ...
        lbl_title2 = Label(bill_Frame, text="Customer Bill Area", font=("goudy old style", 20), bg="orange").pack(
            side=TOP, fill=X)
        ...
        # ====Image==========
        self.bill_photo = Image.open("medical-store-bill-counter-5246957-4391353.png")
