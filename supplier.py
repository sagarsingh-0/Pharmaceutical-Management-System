...
class supplierClass:
    def __init__(self, root):
        ...
        btn_search = Button(self.root, text="Search", command=self.search, cursor="hand2", font=("goudy old style", 15),
        ...
        # ===content
        # ========Row1
        lbl_supplier_invoice = Label(self.root, text="Invoice No.", font=("goudy old style", 15), bg="white").place(
            x=50, y=80)
        txt_supplier_invoice = Entry(self.root, textvariable=self.var_sup_invoice, font=("goudy old style", 15),
                                     bg="white").place(x=180, y=80, width=180)
