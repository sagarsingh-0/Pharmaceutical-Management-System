...
class employeeClass:
    def __init__(self, root):
        ...
        self.root.title("PHARMACUTICAL MANAGEMENT SYSTEM")
        ...
        # ================SearchFrame
        SearchFrame = LabelFrame(self.root, text="Search Employee", font=("goudy old style", 13, "bold"), bd=2,
        ...
        btn_search = Button(SearchFrame, text="Search", command=self.search, cursor="hand2",
                            font=("goudy old style", 15), bg="#4caf50", fg="white").place(x=410, y=9, width=150,
                                                                                          height=30)
        ...
        txt_empid = Entry(self.root, textvariable=self.var_emp_id, font=("goudy old style", 15), bg="white").place(
        ...
        txt_email = Entry(self.root, textvariable=self.var_email, font=("goudy old style", 15), bg="white").place(x=150,
                                                                                                                  y=230,
                                                                                                                  width=180)
        txt_password = Entry(self.root, textvariable=self.var_pass, font=("goudy old style", 15), bg="white").place(
        ...
        # ===============button
        btn_add = Button(self.root, text="Save", command=self.add, cursor="hand2", font=("goudy old style", 15),
                         bg="#2196f3", fg="white").place(x=500, y=305, width=110, height=28)
        btn_update = Button(self.root, text="Update", command=self.update, cursor="hand2", font=("goudy old style", 15),
                            bg="#4caf50", fg="white").place(x=620, y=305, width=110, height=28)
        btn_delete = Button(self.root, text="Delete", command=self.delete, cursor="hand2", font=("goudy old style", 15),
                            bg="#f44336", fg="white").place(x=740, y=305, width=110, height=28)
        btn_clear = Button(self.root, text="Clear", command=self.clear, cursor="hand2", font=("goudy old style", 15),
                           bg="#607d8b", fg="white").place(x=860, y=305, width=110, height=28)
