...
class billClass:
    def __init__(self, root):
        ...
        cTitle = Label(CustomerFrame, text="Customer Details", font=("goudy old style", 15), bg="gray").pack(side=TOP,
                                                                                                             fill=X)
        ...
        txt_p_qty = Entry(Add_CartwidgetsFrame, textvariable=self.var_qty, font=("times new roman", 15),
                          bg="lightyellow").place(x=390, y=35, width=130, height=22)
        ...
        footer = Label(self.root,
                       text="PMS-Pharmacutical Management System | Developed By Sagar,Chitta,Ayush,Laxmipriya,Soumya,Suvashree",
    ...
    def bill_top(self):
        ...
        bill_top_temp = f'''
\t\tPharmacy-Shop
\t Phone No. 9875213640, Cuttack-753001
{str("=" * 47)}
