...
class Login_System:
    def __init__(self, root):
        self.root = root
        self.root.title("Login System Developed BY|Sagar,Chitta,Ayush,Laxmipriya,Soumya,Suvashree")
        self.root.geometry("1350x700+0+0")
        self.root.config(bg="#fafafa")
        # ===images======
        self.phone_image = ImageTk.PhotoImage(file="WhatsApp Image 2023-05-23 at 17.31.07.jpg")
        self.lbl_Phone_image = Label(self.root, image=self.phone_image, bd=0).place(x=45, y=35)
        ...
        lbl_pass = Label(login_frame, text="Password", font=("Andalus", 15), bg="white", fg="#767171").place(x=50,
                                                                                                             y=200)
        txt_pass = Entry(login_frame, show="*", textvariable=self.password, font=("times new roman", 15),
        ...
        lbl_reg = Label(register_frame, text="Developed|Sagar,Chitta,Ayush,Laxmipriya,Soumya,Suvashree",
                        font=("times new roman", 10), bg="white").place(x=0, y=20, relwidth=1)
        ...
        try:
            if self.employee_id.get() == "":
                ...
                if email == None:
                    ...
                    title = Label(self.forget_win, text='Reset Password', font=('gouddy old style', 15, 'bold'),
                    ...
                    lbl_new_pass = Label(self.forget_win, text="New Password", font=("times new roman", 15)).place(x=20,
                                                                                                                   y=160)
                    ...
                    lbl_c_pass = Label(self.forget_win, text="Confirm Password", font=("times new roman", 15)).place(
                        x=20, y=225)
                    ...
                    self.btn_update = Button(self.forget_win, text="Update", state=DISABLED,
